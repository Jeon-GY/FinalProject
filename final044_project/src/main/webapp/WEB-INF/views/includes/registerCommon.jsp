...
<div>
	...
	<div id="pptForSaleList">
		<div class="form-group">
			<label>판매자ID</label>
			<input name="userId" value="${pptForSaleList[0].userId}" class="id" readonly>
		</div>
		<div class="form-group">
			<input name="pptForSaleId" type="hidden" value="${pptForSaleList[0].pptForSaleId}" class="id" readonly>
		</div>
		<div class="form-group">
			<label>게시글 제목</label>
		...
		<div class="form-group">
			<label>상세 정보</label>
			<input name="content" value="${pptForSaleList[0].content}" class="form-control" readonly>
		</div>
	</div>
