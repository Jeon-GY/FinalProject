         ...
         <form action="/party/registParty" method="post" role="form" id="usercheck" name="member">
            <div class="form-group">
             <h3>회원가입</h3>
               ...
               <input type="text" class="form-control" id="userId" name="userId" placeholder="ID" value="${curUser.userId}">
               ...
               <input type="password" class="form-control" id="userPassword" name="userPassword" value="${curUser.userPassword}" placeholder="Confirm Password">
               <div class="eheck_font" id="userPassword_check"></div>

               <label for="name">이름</label>
               <input type="text" class="form-control" id="userName" name="userName" placeholder="Name" value="${curUser.userName}">
               <div class="eheck_font" id="name_check"></div>

               <label for="email">이메일 주소</label>
               <input type="email" class="form-control" id="email" name="email" placeholder="E-mail" value="${curUser.email}">
               <div class="eheck_font" id="email_check"></div>

               <label for="phone">휴대폰 번호('-'없이 번호만 입력해주세요)</label>
               <input type="tel" class="form-control" id="phone" name="phoneNumber" placeholder="Phone Number" value="${curUser.phoneNumber}">
               <div class="eheck_font" id="phone_check"></div>

               <label for="birthDate">생년월일</label>
               <input type="text" class="form-control" id="birthDate" name="birthDate" placeholder="ex) 19990101" value="${curUser.birthDate}">
               ...
               <input type="hidden" class="form-control" id="address" name="address" placeholder="주소" value="${curUser.address}">
               <input type='hidden' name='${_csrf.parameterName}' value='${_csrf.token}'>
               <hr>
               <label for="gender">성별 </label>
               <input name="sex" id="sex" value="${curUser.sex}" type="hidden">
               <input type="checkbox" name="gender" onclick="changeSex(1)">남
               <input type="checkbox" name="gender" onclick="changeSex(0)">여

               <button type="submit" class="zip_code_btn" style="float: right;">회원가입</button>
            </div>
         </form>
      </div>
   </article>
