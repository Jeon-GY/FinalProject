...
<div class="login_tistory">
	...
	<fieldset style="margin-bottom: 60px;">
		<form method="post" action="/login" role="form">
			...
			<input type="submit" class="btn_login" value="로그인" style="text-align: center;">
			...
			<div class="inp_chk">
				...
				<span class="txt_lab">로그인 상태 유지</span></label>
			</div>
		</form>
		<span class="txt_find">
		<a href="/member/find/loginId" class="link_find">아이디</a> / <a href="/member/find/password" class="link_find">비밀번호 찾기</a>
		</span>
...
Kakao.init('ccbacba135af2f8f5fff9a09bf3dea9e');
