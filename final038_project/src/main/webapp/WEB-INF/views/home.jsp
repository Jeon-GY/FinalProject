		...
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="shop-cat-box">
					<img class="img-fluid" src="/resources/images/충청북도 충주-사과2.jpg"
						alt="" /> <a class="btn hvr-hover" href="#">충청북도 충주 사과</a>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="shop-cat-box">
					<img class="img-fluid" src="/resources/images/충청남도 청양-구기자.jpg"
						alt="" /> <a class="btn hvr-hover" href="#">충청남도 청양 구기자</a>
				</div>
			</div>
			<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
				<div class="shop-cat-box">
					<img class="img-fluid" src="/resources/images/전라북도 고창-수박2.jpg"
						alt="" /> <a class="btn hvr-hover" href="#">전라북도 고창 수박</a>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="offer-box-products">
					<img class="img-fluid" src="/resources/images/특산물.jpg" alt="" />
				</div>
			</div>
			<div class="col-lg-6 col-md-6 col-sm-12">
				<div class="offer-box-products">
					<img class="img-fluid" src="/resources/images/관광지.jpg" alt="" />
				</div>
			</div>
		</div>
	</div>
			...
			<div class="col-lg-3 col-md-6 special-grid best-seller">
				<div class="products-single fix">
					<div class="box-img-hover">
						...
						<img src="/resources/images/전라남도 강진군-토하젓.jpg" class="img-fluid"
							alt="Image">
						<div class="mask-icon">
							<ul>
			...
			<div class="col-lg-3 col-md-6 special-grid top-featured">
				<div class="products-single fix">
					<div class="box-img-hover">
						...
						<img src="/resources/images/제주-한라봉3.jpg" class="img-fluid"
							alt="Image">
						<div class="mask-icon">
							<ul>
								<li><a href="#" data-toggle="tooltip"
			...
			<div class="col-lg-3 col-md-6 special-grid top-featured">
				<div class="products-single fix">
					<div class="box-img-hover">
						...
						<img src="/resources/images/강원 정선-찰옥수수2.jpg" class="img-fluid"
							alt="Image">
						<div class="mask-icon">
							<ul>
								<li><a href="#" data-toggle="tooltip"
			...
			<div class="col-lg-3 col-md-6 special-grid best-seller">
				<div class="products-single fix">
					<div class="box-img-hover">
						...
						<img src="/resources/images/충청북도 보은-대추2.jpg" class="img-fluid"
							alt="Image">
						<div class="mask-icon">
							<ul>
								<li><a href="#" data-toggle="tooltip"
