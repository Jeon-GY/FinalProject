...
public class ReplyController {
	...
	public ResponseEntity<Quad<Criteria, Criteria, List<PptForSaleVO>, List<PptForSaleVO>>> getReplyListWithPaging(@PathVariable("originalId") String originalId,
					@PathVariable("reviewPage") int reviewPage, @PathVariable("qnaPage") int qnaPage) {
		...
		return new ResponseEntity<>(pptForSaleService.getReplyListWithPaging(reviewCri, qnaCri, originalId),HttpStatus.OK);
	}
