...
public class PostController {
	...
	public void searchingProductList(HttpServletRequest request, String locationId, @ModelAttribute("criteria") Criteria criteria, Party party,
			Model model) {
		HttpSession session = request.getSession();
		Party loginParty = new Party();
		loginParty = (Party) session.getAttribute("loginParty");
	...
	public String registerPost(HttpServletRequest request, PptForSaleVO pptForSale, PptVO ppt, PostVO post, LocationVO location,
		...
		pptService.registerPpt(location, productCategory);
